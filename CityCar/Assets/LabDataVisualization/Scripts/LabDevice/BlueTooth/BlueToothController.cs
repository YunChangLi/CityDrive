...
namespace LabDevice
{
    ...
    public class BlueToothController:DeviceBase
    {
        ...
        private StringBuilder _rawDataBuilder;
        public string BluetoothData { get; private set; }
        Thread _readThread;
        bool _keepReading;
        ...
        public void Init()
        {
            ...
            _rawDataBuilder=new StringBuilder();
